...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        titleBar.setTitle(fragmentArgs.getString("Name"));
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
    ...
    protected void sendMessage(EMMessage message){
        ...
        // Send message.
        message.setAttribute("name",  ChatSpUtil.getString("ChatName",getContext()));
        message.setAttribute("pic", ChatSpUtil.getString("ChatPic",getContext()));
