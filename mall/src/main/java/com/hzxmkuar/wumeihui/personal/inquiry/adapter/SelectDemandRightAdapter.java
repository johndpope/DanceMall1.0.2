...
import com.hzxmkuar.wumeihui.databinding.SelectRightDemandItemBinding;
...
public class SelectDemandRightAdapter extends BaseAdapter<InquiryListTo, SelectRightMainDemandItemBinding> {

   private String serviceIds;
    private boolean isService;
    public SelectDemandRightAdapter(Activity context ,String serviceIds) {
        super(context);
        this.serviceIds=serviceIds;
    }
    public SelectDemandRightAdapter(Activity context ,String serviceIds,boolean isService) {
        super(context);
        this.serviceIds=serviceIds;
