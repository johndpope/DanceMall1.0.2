...
public class ModifyCaseActivity extends BaseActivity implements PermissionListener, UploadImageIdListener {
    ...
    private ShopInfoTo.CaseExampleBean caseTo;
    ...
    private void setView() {
        caseTo = (ShopInfoTo.CaseExampleBean) getIntent().getSerializableExtra("CaseTo");
        if (caseTo !=null){
            caseDes.setText(caseTo.getDesc());
            displayImage(companyImage, caseTo.getPic());
        }
    }
