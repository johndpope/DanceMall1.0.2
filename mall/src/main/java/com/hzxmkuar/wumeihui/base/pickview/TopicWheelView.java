...
package com.hzxmkuar.wumeihui.base.pickview;
 ...
 */
public class TopicWheelView extends WheelView {
     ...
     * Constructor
     */
    public TopicWheelView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public TopicWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }
     ...
     * Constructor
     */
    public TopicWheelView(Context context) {
        super(context);
        initData(context);
    }
