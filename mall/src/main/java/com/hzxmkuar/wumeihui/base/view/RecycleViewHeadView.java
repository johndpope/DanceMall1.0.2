package com.hzxmkuar.wumeihui.base.view;
...
/**
 * Created by xzz on 2018/5/9.
 */

public class RecycleViewHeadView extends LinearLayout implements IRefreshHeader {
    ...
    public RecycleViewHeadView(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public RecycleViewHeadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(com.github.jdsjlzx.R.layout.listview_header, null);
